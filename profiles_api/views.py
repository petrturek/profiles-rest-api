...
from rest_framework.permissions import IsAuthenticated #IsAuthenticatedOrReadOnly... buď anebo
...
class HelloApiView(APIView):
    ...
    def get(self, request, format=None): # format je best practice, tady se nepoužije
...
class UserProfileViewset(viewsets.ModelViewSet): # django zná veškeré akce, které jsou na tomto možné (list, create, update, partial_update a destroy) - výhoda ModelViewSet
